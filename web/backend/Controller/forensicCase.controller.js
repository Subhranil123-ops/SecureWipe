...
exports.assignCase = asyncHandler(
    async (req, res) => {
        res.json({
            success: true,
            message:
...
exports.ingestResult = asyncHandler(
    async (req, res) => {
        res.json({
            success: true,
            message:
...
exports.generateReport = asyncHandler(
    async (req, res) => {
        res.json({
            success: true,
            data:
